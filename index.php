...
<html lang="en">
  <head>
    ...
    <link href="/bootstrap-4.0.0-beta/docs/4.0/examples/cover/cover.css" rel="stylesheet">
  </head>
      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="masthead clearfix">
            <div class="inner">
              <h3 class="masthead-brand">MoMo</h3>
          ...
          <div class="inner cover">
            <h1 class="cover-heading">Welcome to MOMO's</h1>
            <p class="lead">Find out who is MOMO, MOMO's projects, and more.</p>
            <p class="lead">
              <a href="momo.php" class="btn btn-lg btn-secondary">Let's Go</a>
            </p>
          </div>
